...
const oneBase: Omit<OneShot,"draftDrive"|"draftPdf"|"pdf"|"driveLink"|"uploadedAt"|"_draftPdfFile">[] = [
  ...
  {"code":"diseno_tercerizacion","name":"Establecer un procedimiento para la tercerización","resp":"Diseño","start":addDays(PROJECT_START,49).toISOString(),"end":addDays(PROJECT_START,55).toISOString(),"details":["Establecer una guía para la tercerización (orden de cómo se debe tercerizar). <br /> Establecer un lugar para documentar los tiempos que insumió la tercerización. <br /> Establecer en conjunto con comercial, pedidos que pueden ser tercerizados sin necesidad de pasar por diseño (creación de una preproducción que pueda ejecutar comercial, criterios claros de que si y que no, donde se documenta, etc). <br /> Entregables: Guía para la tercerización (que se terceriza donde, cual es el flujo para tercerizar, mails de ejemplo, coordinación de los envíos necesarios, etc). <br /> Excel para documentar tiempos de la tercerización, cuanto tiempo toman los trabajos. <br /> Acuerdo con comercial de productos tercerizables por ellos."]},
