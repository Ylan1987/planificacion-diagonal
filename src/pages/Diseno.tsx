...
const oneBase: Omit<OneShot,"draftDrive"|"draftPdf"|"pdf"|"driveLink"|"uploadedAt"|"_draftPdfFile">[] = [
  {"code":"diseno_briefs","name":"Estandarizar briefs y checklist de entrada","resp":"Diseño","start":addDays(PROJECT_START,0).toISOString(),"end":addDays(PROJECT_START,6).toISOString(),"details":["Plantilla de brief + checklist mínimo."]},
  {"code":"diseno_plantillas","name":"Definir plantillas de piezas frecuentes","resp":"Diseño","start":addDays(PROJECT_START,7).toISOString(),"end":addDays(PROJECT_START,20).toISOString(),"details":["Paquete de plantillas (AI/PSD/FIG)."]},
  {"code":"diseno_aprob","name":"Flujo de aprobación con Comercial","resp":"Diseño + Comercial","start":addDays(PROJECT_START,21).toISOString(),"end":addDays(PROJECT_START,34).toISOString(),"details":["Diagrama de aprobación + SLAs."]}
];
